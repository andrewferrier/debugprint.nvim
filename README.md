...
| Extra visual emphasis of log statements                             | Highlights inserted lines | Flashes to highlight lines on insertion               | status line counter, signcolumn, line-highlight, scrollbar     | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                                   |
