...
| Feature                                                             | `debugprint.nvim` | [nvim-chainsaw](https://github.com/chrisgrieser/nvim-chainsaw) | [vim-debugstring](https://github.com/bergercookie/vim-debugstring) | [printer.nvim](https://github.com/rareitems/printer.nvim) | [refactoring.nvim](https://github.com/ThePrimeagen/refactoring.nvim) | [vim-printer](https://github.com/meain/vim-printer) | [vim-printf](https://github.com/mptre/vim-printf) | [logsitter](https://github.com/gaelph/logsitter.nvim) |
| ------------------------------------------------------------------- | ----------------- | -------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------- |
| Auto-generation of debug line, incl. locator info                   | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :x:                                                 | :x:                                               | :+1:                                                  |
| Print plain debug lines                                             | :+1:              | :+1:                                                           | :+1:                                                               | :x:                                                       | :+1:                                                                 | :x:                                                 | :x:                                               | :x:                                                   |
| Print variables using current word/heuristic                        | :+1:              | :+1:                                                           | :+1:                                                               | :x:                                                       | :x:                                                                  | :+1:                                                | :+1:                                              | :x:                                                   |
| Print variables using treesitter                                    | :+1:              | :+1:                                                           | :x:                                                                | :x:                                                       | :+1:                                                                 | :x:                                                 | :x:                                               | :x:                                                   |
| Print variables/expressions using prompts                           | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Print variables using motions                                       | :+1:              | :x:                                                            | :x:                                                                | :+1:                                                      | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Print variables using visual mode                                   | :+1:              | :+1:                                                           | :x:                                                                | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :x:                                                   |
| Print assertions                                                    | :x:               | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Print stack traces                                                  | :x:               | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Add time-tracking logic                                             | :x:               | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Add debugging breakpoints                                           | :x:               | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Print debug lines above/below current line                          | :+1:              | :x:                                                            | :x:                                                                | (via global config)                                       | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| Supports [dot-repeat](https://www.vikasraj.dev/blog/vim-dot-repeat) | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Can control whether to move to inserted lines                       | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Clean up all debug lines                                            | :+1:              | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Comment/uncomment all debug lines                                   | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Can put debugprint text into default register                       | :x:               | :x:                                                            | :x:                                                                | :+1:                                                      | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| *Built-in support for:*                                             | -                 | -                                                              | -                                                                  | -                                                         | -                                                                    | -                                                   | -                                                 | -                                                     |
| AppleScript                                                         | :+1:              | :+1:                                                           | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| arduino                                                             | :x:               | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| bash/sh                                                             | :+1:              | :+1:                                                           | :+1:                                                               | :+1:                                                      | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| C                                                                   | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :+1:                                              | :x:                                                   |
| C#                                                                  | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| C++                                                                 | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :+1:                                              | :x:                                                   |
| CMake                                                               | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| dart                                                                | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Docker                                                              | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| DOS/Windows Batch                                                   | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Elixir                                                              | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| fish                                                                | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Fortran                                                             | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| Golang                                                              | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :+1:                                                  |
| Haskell                                                             | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Java                                                                | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :x:                                                   |
| Javascript/Typescript                                               | :+1:              | :+1:                                                           | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :+1:                                                  |
| Kotlin                                                              | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| lean                                                                | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| lua                                                                 | :+1:              | :+1:                                                           | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :+1:                                                  |
| GNU Make                                                            | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Perl                                                                | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| PHP                                                                 | :+1:              | :x:                                                            | :+1:                                                               | :x:                                                       | :+1:                                                                 | :x:                                                 | :x:                                               | :x:                                                   |
| Powershell/ps1                                                      | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Python                                                              | :+1:              | :+1:                                                           | :+1:                                                               | :+1:                                                      | :+1:                                                                 | :+1:                                                | :x:                                               | :x:                                                   |
| R                                                                   | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Ruby                                                                | :+1:              | :+1:                                                           | :+1:                                                               | :x:                                                       | :+1:                                                                 | :x:                                                 | :x:                                               | :x:                                                   |
| Rust                                                                | :+1:              | :+1:                                                           | :+1:                                                               | :+1:                                                      | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| Swift                                                               | :+1:              | :x:                                                            | :x:                                                                | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| VimL (vimscript)                                                    | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| zsh                                                                 | :+1:              | :x:                                                            | :+1:                                                               | :+1:                                                      | :x:                                                                  | :+1:                                                | :x:                                               | :x:                                                   |
| Add custom filetypes (doced/supported)                              | :+1:              | :+1:                                                           | :x:                                                                | :+1:                                                      | :x:                                                                  | :x:                                                 | :+1:                                              | :+1:                                                  |
| Customizable callback formatter                                     | :x:               | :x:                                                            | :x:                                                                | :+1:                                                      | :x:                                                                  | :x:                                                 | :x:                                               | :x:                                                   |
| Implemented in                                                      | Lua               | Lua                                                            | VimL                                                               | Lua                                                       | Lua                                                                  | VimL                                                | VimL                                              | Lua                                                   |
