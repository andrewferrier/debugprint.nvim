...
| ------------------------------------------------------------------- | ----------------- | ------------------------------------------------------- | -------------------------------------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------- | ----------------------------------------------------- |
| Include location information in log lines                           | :+1:              | :x:                                                     | :+1: (via user config)                                         | :+1:                                                      | :+1:                                                                 | :x:                                                 | :+1:                                                  |
...
| Use treesitter queries to locate log targets and insert them        | :x:               | :+1:                                                    | :x:                                                            | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                                   |
...
| Flashes to highlight lines when inserted                            | :x:               | :+1:                                                    | :x:                                                            | :x:                                                       | :x:                                                                  | :x:                                                 | :x:                                                   |
